    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="mx-auto max-w-4xl px-6 py-10">
        ...
        <div className="mt-5 grid grid-cols-2 gap-3">
          <Link
            href={`/reviews?trust_id=${id}`}
            className="flex items-center gap-3 rounded-xl bg-white p-4 ring-1 ring-gray-200 hover:ring-emerald-300 hover:shadow-sm transition-all group"
          >
            ...
            <div>
              <p className="text-sm font-medium text-gray-900 group-hover:text-emerald-700 transition-colors">Reviews</p>
              <p className="text-xs text-gray-400">Rate your experience</p>
            </div>
          </Link>
          <Link
            href={`/interview-intel?trust_id=${id}`}
            className="flex items-center gap-3 rounded-xl bg-white p-4 ring-1 ring-gray-200 hover:ring-emerald-300 hover:shadow-sm transition-all group"
          >
            ...
            <div>
              <p className="text-sm font-medium text-gray-900 group-hover:text-emerald-700 transition-colors">Interview Intel</p>
              <p className="text-xs text-gray-400">See what to expect</p>
            </div>
          </Link>
        </div>
