          ...
          <div className="grid gap-5 sm:grid-cols-3">
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-white p-8 ring-1 ring-gray-200 hover:ring-emerald-200 hover:shadow-lg transition-all duration-200">
              ...
              <p className="text-sm leading-relaxed text-gray-500">
                Filter by grade (FY1 through Consultant), specialty, location,
                and trust type. No noise, just the roles that match your career stage.
              </p>
              <div className="mt-5 flex flex-wrap gap-1.5">
                {["FY1", "ST3", "Consultant", "London", "North West"].map((tag) => (
                  <span
                    key={tag}
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-white p-8 ring-1 ring-gray-200 hover:ring-emerald-200 hover:shadow-lg transition-all duration-200">
              ...
              <p className="text-sm leading-relaxed text-gray-500">
                ...
                quality, consultant support, banding accuracy and culture, before
                you apply.
              </p>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-white p-8 ring-1 ring-gray-200 hover:ring-emerald-200 hover:shadow-lg transition-all duration-200">
              ...
              <p className="text-sm leading-relaxed text-gray-500">
                ...
                who've interviewed at each trust. Walk in ready, not guessing.
              </p>
      ...
      <section className="bg-emerald-600 px-6 py-16">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mb-8 text-emerald-100">
            Built by doctors, for doctors. Browse NHS roles with filters that actually make sense for your career stage.
          </p>
          <Link
            href="/jobs"
